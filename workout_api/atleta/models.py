...
from sqlalchemy import Boolean, DateTime, ForeignKey, Integer, String, Float, UUID
...
class AtletaModel(BaseModel):
    ...
    id_centro_treinamento: Mapped[int] = mapped_column(Integer, ForeignKey("centros_treinamento.pk_id"))
    categoria: Mapped[CategoriaModel] = relationship('CategoriaModel', back_populates='atletas')
    id_categoria: Mapped[int] = mapped_column(Integer, ForeignKey("categorias.pk_id"))
